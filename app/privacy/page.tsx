...
export const metadata: Metadata = {
  ...
  description: "MIDEEYE Privacy Policy — how we collect, use, and protect your data.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-invert prose-teal">
      ...
      <p>
        ...
        you when you use our platform at <strong>mideeye.com</strong>.
      </p>
      ...
      <ul>
        ...
        <li><strong>Content:</strong> questions, answers, comments, showcase posts</li>
        <li><strong>Communications:</strong> direct messages between users</li>
        <li><strong>Settings:</strong> notification preferences, theme</li>
      </ul>
      ...
      <ul>
        ...
        <li>Send notifications about activity on your content (with your consent)</li>
      ...
      <ul>
        ...
        <li><strong>Legitimate interests:</strong> security monitoring, fraud prevention, analytics</li>
        <li><strong>Consent:</strong> marketing emails, optional cookies, push notifications</li>
      ...
      <ul>
        <li><strong>Supabase Inc.</strong> — our database and authentication provider (EU data residency available)</li>
        <li><strong>Vercel Inc.</strong> — our hosting provider</li>
        <li><strong>Email provider</strong> — transactional email delivery only</li>
        <li><strong>Law enforcement</strong> — when legally required with a valid request</li>
      </ul>
      <p>All processors are bound by data processing agreements and GDPR safeguards.</p>

      <h2>5. Data Retention</h2>
      <ul>
        <li><strong>Active accounts:</strong> data retained while account is active</li>
        <li><strong>Deleted accounts:</strong> personal data removed within 30 days; anonymised content may remain</li>
        <li><strong>Logs:</strong> server logs retained for 90 days</li>
        <li><strong>Backups:</strong> purged within 60 days of deletion request</li>
      </ul>
      ...
      <p>
        ...
        All personal information will be permanently removed within 30 days. Public content
        (questions and answers) may be retained in anonymised form to preserve community knowledge.
      </p>
      ...
      <h2>9. Children</h2>
      <p>
        MIDEEYE is not directed at children under 13 (or 16 in the EU/EEA).
      ...
      <p>
        ...
        including the United States. We ensure appropriate safeguards (Standard Contractual
        Clauses) are in place for all such transfers.
      </p>

      <h2>11. Security</h2>
      <p>
        We use industry-standard measures including HTTPS/TLS encryption, Row Level Security
        on our database, hashed passwords via Supabase Auth, and regular security reviews.
      ...
      <p>
        ...
        banner at least 7 days before taking effect.
      </p>

      <h2>13. Contact &amp; Jurisdiction</h2>
      <p>
        <strong>Data Controller:</strong> {COMPANY_NAME}<br />
        <strong>Email:</strong> <a href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a><br />
        <strong>Governing Law:</strong> This policy is governed by applicable data protection
        law. EU/EEA residents may lodge complaints with their local supervisory authority.
      </p>
    </div>
  );
}
