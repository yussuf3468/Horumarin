      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-stone-50 to-stone-100">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto mb-8">
            <p className="text-xl text-stone-700 leading-relaxed">
              Bulshada Soomaaliyeed maanta waxay ku tiirsan tahay baraha
              bulshada sida Facebook, YouTube, iyo WhatsApp si ay u helaan xog
              iyo talo, balse macluumaadkaas marar badan waa mid aan la hubin,
              been ah ama si khaldan loo fahmay. Ma jiro meel lagu kalsoonaan
              karo oo dadka Soomaaliyeed ku wada kulmaan si ay u waydiiyaan, u
              bartaan, una helaan jawaabo run ah oo afkooda hooyo ku qoran.
            </p>
          </div>
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-stone-600 mt-4 max-w-3xl mx-auto">
              Horumarin waa madal casri ah oo u dhisan si ay bulshada
              Soomaaliyeed uga hesho meel lagu kalsoonaan karo, af-Soomaali ah,
              oo lagu barto, lagu wadaago, laguna horumaro — madal diiradda
              saarta aqoon, wada-shaqayn iyo horumar, ma ahan madadaalo.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-stone-400 text-sm leading-relaxed">
                Ku soo biir bulshada Soomaaliyeed ee dhisaysa mustaqbalka
                aqoonta. Waanu kuu soo diri doonaa warka marka aan bilaabno.
              </p>
            </div>
          </div>
